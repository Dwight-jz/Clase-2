...
class UI
{
  addProduct(producto)
  {
      ...
      elemento.innerHTML=`
      <div class="tarjeta texto margen4" id="info" style="margin-left: 40%;">
            <div class="tarjeta-body">
            <br>
            <strong> PRODUCTO </strong> :  ${producto.nombre} -
            <strong> PRECIO </strong> :  ${producto.precio} -
            <strong> AÑO </strong> :  ${producto.año} - <br><br>
            <a href="" class="btn btn-lg btn-primary" id="btneli" name="eliminar"style="margin-left: -02%; margin-bottom: 2%; height: 15%; width: 80%; font-size: 90%;" > Eliminar  </a> 
            </div>
            </div>
            `;
